...
ln -s /var/www/ethnoidea-new/vagrant/php/fpm/php.ini /etc/php/5.6/fpm/php.ini
mv /etc/php/5.6/fpm/pool.d/www.conf /etc/php/5.6/fpm/pool.d/www.conf.dmp
ln -s /var/www/ethnoidea-new/vagrant/php/fpm/pool.d/www.conf /etc/php/5.6/fpm/pool.d/www.conf
...
ln -s /var/www/ethnoidea-new/vagrant/nginx/app.conf /etc/nginx/sites-enabled/app.conf
echo "Done!"

info "Enabling xdebug configuration"
mv /etc/php/5.6/mods-available/xdebug.ini /etc/php/5.6/mods-available/xdebug.ini.dmp
cp /var/www/ethnoidea-new/vagrant/php/mods-available/xdebug.ini /var/www/ethnoidea-new/vagrant/php/mods-available/xdebug-local.ini
ln -s /var/www/ethnoidea-new/vagrant/php/mods-available/xdebug-local.ini /etc/php/5.6/mods-available/xdebug.ini
echo "Done!"
